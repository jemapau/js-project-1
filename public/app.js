...
},{"./footer":351,"./header":352,"./homepage":353,"./signin":359,"./signup":361,"./user-page":367,"babel-polyfill":1,"page":330}],356:[function(require,module,exports){
'use strict';
...
(0, _page2.default)('/:username', loadUser, _header2.default, _title2.default, function (ctx, next) {
  var main = document.getElementById('main-container');
  (0, _title2.default)('Instagram - ' + ctx.user.username);
...
},{"../header":352,"./template":368,"empty-element":299,"page":330,"title":341}],368:[function(require,module,exports){
'use strict';
...
module.exports = function (user) {
  var el = yo(_templateObject, user.avatar, user.username, user.username, user.pictures.map(function (picture) {
    return yo(_templateObject2, picture.src, picture.likes);
  }));

  return layout(el);
};

},{"../layout":357,"../translate":366,"yo-yo":342}]},{},[355]);
